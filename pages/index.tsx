...

{
  /* <div className="bg-slate-400 py-20 px-10 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-2xl">
        ...
        <ul>
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              key={i}
              className="flex justify-between my-2 odd:bg-red-500 even:bg-blue-500"
            >
        ...
        {["a", "b", "c", ""].map((c, i) => (
          <li className="bg-red-500 empty:hidden" key={i}>
            {c}
          </li>
        ))}
        ...
        <button
          className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-4/6 mx-auto
      ...
      <div className="bg-white overflow-hidden rounded-3xl shadow-2xl group">
        ...
        <div className="relative -mt-1 -mb-16 -top-24 flex flex-col items-center ">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              <button className="bg-blue-200 rounded-md flex justify-center items-center aspect-square w-8 text-xl text-gray-500">
                -
              </button>
              <span>1</span>
              <button className="bg-blue-200 rounded-md flex justify-center items-center aspect-square w-8 text-xl text-gray-500">
