      ...
      <div className="px-4 py-10">
        <div className="mb-8">
          ...
          <div className="mt-5">
            ...
            <p className="block text-3xl mt-3 text-gray-900">$140</p>
            ...
            <div className="flex items-center justify-between space-x-2">
              ...
              <button className="p-3 rounded-full focus:outline-none flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500">
                <svg
                  className="h-6 w-6 "
